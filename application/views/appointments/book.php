                        ...
                        <div class="frame-content row">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="address" class="form-control required" maxlength="120" />
                                </div>
                                <div class="form-group">
                                    <label for="city" class="control-label"><?= lang('city') ?> *</label>
                                    <input type="text" id="city" class="form-control required" maxlength="120" />
                                </div>
                                <div class="form-group">
                                    <label for="zip-code" class="control-label"><?= lang('zip_code') ?> *</label>
                                    <input type="text" id="zip-code" class="form-control required" maxlength="120" />
                                </div>
                                <div class="form-group">
                                    <label for="notes" class="control-label"><?= lang('notes') ?> *</label>
                                    <textarea id="notes" maxlength="500" class="form-control required" rows="3"></textarea>
                                </div>
                            </div>
